...
documentsRouter.get("/documents/me", requireAuth, requireRole("Driver"), async (req, res, next) => {
  try {
...
documentsRouter.post("/documents", requireAuth, requireRole("Driver"), async (req, res, next) => {
  try {
...
documentsRouter.post("/documents/:id/resubmit", requireAuth, requireRole("Driver"), async (req, res, next) => {
  try {
...
documentsRouter.get("/documents/:id/view", requireAuth, async (req, res, next) => {
  try {
...
documentsRouter.patch("/documents/:id/review", requireAuth, requireRole("Admin"), async (req, res, next) => {
  try {
