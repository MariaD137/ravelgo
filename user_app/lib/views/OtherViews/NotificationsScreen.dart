...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  IconData _iconFor(String type) {
    ...
    if (type.startsWith('RENTAL_')) return Icons.car_rental;
    if (type.startsWith('PAYMENT_')) return Icons.payment;
        ...
        child: ListView(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                'Ride, delivery, rental and payment updates will appear here as they happen.',
