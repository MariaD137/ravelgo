...
/// can actually be sent. The screen validates the address and clearly states
/// that delivery requires the auth service - it never claims an email was
/// sent. `_requestReset` is the integration point for the future backend.
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void _requestReset() {
    ...
    // Integration point: call the auth service's password-reset endpoint here.
    setState(() {
      _error = null;
      _submitted = true;
    });
