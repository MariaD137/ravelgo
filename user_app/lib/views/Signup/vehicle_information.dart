...
import 'package:ravelgo_user/views/Popup/colour_picker.dart';
...
class VehicleInformationScreen extends StatefulWidget {
  ...
  @override
  State createState() => _VehicleInformationScreenState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                items: [DropdownMenuItem(value: '2013', child: Text('2013'))],
                onChanged: (_) {},
              ...
              SizedBox(height: 6),
              DropdownButtonFormField<String>(
                items: [DropdownMenuItem(value: 'Kia', child: Text('Kia'))],
                onChanged: (_) {},
                decoration: _decoration,
              ),
