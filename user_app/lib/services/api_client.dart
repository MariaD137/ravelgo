...
/// The single HTTP client every rider screen uses to reach the RavelGo
/// backend. Attaches the signed-in user's Cognito ACCESS token as a Bearer
/// header (the backend verifies access tokens — see
/// backend/src/middleware/auth.ts) and points at API_BASE_URL from the app's
/// .env.
class ApiClient {
...
String describeApiFailure(Object error, {String what = 'this'}) {
  ...
  switch (error.statusCode) {
    ...
    case 403:
      return 'This account doesn\'t have access to $what.';
    case 404:
