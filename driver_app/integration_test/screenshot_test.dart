...
// see splash_screen.dart, which routes to LoginScreen() once AuthService
...
import 'package:ravelgo_driver_app/main.dart' as app;
...
void main() {
  ...
  testWidgets('capture splash and login screens', (tester) async {
    ...
    await tester.pump();
    await binding.takeScreenshot('driver_app_01_splash');
    ...
    await binding.takeScreenshot('driver_app_02_login');
  });
}
