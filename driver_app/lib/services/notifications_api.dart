...
/// notification this app shows was created from an actual event: a trip
/// or delivery status change this driver was party to.
class AppNotification {
  ...
  final String body;
  final bool read;
  final String? referenceType; // e.g. "TRIP", "COURIER_REQUEST"
...
/// The signed-in driver's own notifications, proxied through the RavelGo
