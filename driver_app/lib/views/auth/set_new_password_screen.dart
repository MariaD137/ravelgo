...
/// e.g. an operator-created driver account signing in for the first time
/// with the temporary password Cognito emailed them. Mirrors admin_app's
/// screen of the same name (audit Finding D3: this app previously had no
/// way to complete this flow at all).
