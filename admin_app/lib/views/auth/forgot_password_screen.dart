      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Enter your work email and we will help you regain access.',
            ...
            TextField(
              ...
              decoration:
                  InputDecoration(labelText: 'Work email', hintText: 'admin@ravelgo.com', errorText: _error),
            ),
            const SizedBox(height: 24),
            SizedBox(
            ...
            if (_submitted) ...[
              ...
              Container(
                ...
                child: const Text(
                  ...
                  'authentication service, so no reset email can be sent. Contact your '
                  'platform administrator to regain access.',
                  style: TextStyle(color: AppColors.textSecondary),
                ),
              ),
            ],
