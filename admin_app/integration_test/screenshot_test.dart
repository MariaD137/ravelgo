...
// see splash_screen.dart, which routes to AdminLoginScreen() once
// AuthService confirms there's no stored/valid Admin session). Run via
// test_driver/integration_test.dart so screenshots land as real PNG
// files, not just pass/fail assertions.
import 'package:flutter_test/flutter_test.dart';
import 'package:integration_test/integration_test.dart';
import 'package:ravelgo_admin/main.dart' as app;
...
void main() {
  ...
  testWidgets('capture splash and login screens', (tester) async {
    ...
    await tester.pump();
    await binding.takeScreenshot('admin_app_01_splash');
    ...
    await binding.takeScreenshot('admin_app_02_login');
  });
}
